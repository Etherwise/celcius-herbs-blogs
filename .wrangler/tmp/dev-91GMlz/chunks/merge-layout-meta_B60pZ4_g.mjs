...
import { c as createLucideIcon, b as useControllableState, j as jsxRuntimeExports, d as Primitive, e as composeEventHandlers, f as Presence, g as createContextScope, h as useComposedRefs, i as useLayoutEffect2, k as createCollection, a as cn } from './PageRoot_CAKxSx1p.mjs';
import { a as reactExports, R as React } from './_@astro-renderers_BOWlyOdS.mjs';
import { k as useId, s as syncShopifyCart } from './cartdrawer_BXbKZSha.mjs';
import { B as Button } from './button_DF0oUIQF.mjs';
import { A as ArrowLeft } from './sun_kL0qGYUv.mjs';
import { g as getProduct, u as updateCartLines, a as addCartLines, c as createCart } from './storefront_CYM7z2Iz.mjs';
...
function resolveVariantForSize(variants, size) {
  if (size === "full") {
...
function lineOfferMatches(lineAttrs, size, purchase) {
...
async function handleAddToCartRule({
  productName,
  size,
  purchase,
  qty,
  ...
  if (cartId && cart) {
    const existingLine = cart.lines.find(
      (l) => l.merchandise.id === variantId && lineOfferMatches(l.attributes, size, purchase)
    );
    if (existingLine) {
...
const SHOPIFY_PRODUCT_HANDLES = {
  index: null,
  scalpPsoriasisShampoo: null,
  catDandruffLotion: null,
  folliculitisShampoo: null,
  dermvedaFolliculitisShampoo: null,
  earInfectionDrops: null,
  vglowYeastSerum: null
};

async function mergeShopifyProductSeo(handle, fallback) {
  return { ...fallback };
}

export { Award as A, ChevronLeft as C, Leaf as L, Moon as M, RotateCcw as R, Star as S, Truck as T, ChevronRight as a, Accordion as b, AccordionItem as c, AccordionTrigger as d, AccordionContent as e, Check as f, Carousel as g, handleAddToCartRule as h, CarouselContent as i, CarouselItem as j, CarouselPrevious as k, CarouselNext as l, mergeShopifyProductSeo as m, SHOPIFY_PRODUCT_HANDLES as n };
