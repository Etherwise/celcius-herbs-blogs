...
import { c as createLucideIcon, i as useLayoutEffect2, j as jsxRuntimeExports, a as cn, l as useCallbackRef$1, h as useComposedRefs, d as Primitive, f as Presence, m as Portal$1, e as composeEventHandlers, g as createContextScope, n as createSlot, D as DismissableLayer, o as createContext2, b as useControllableState, X, p as cva, u as ue } from './PageRoot_CAKxSx1p.mjs';
import { a as reactExports, b as React } from './_@astro-renderers_BOWlyOdS.mjs';
import { B as Button } from './button_DF0oUIQF.mjs';
import { b as getCart, r as removeCartLines, u as updateCartLines } from './storefront_CYM7z2Iz.mjs';
...
function useStore(store, { keys, deps = [store, keys], ssr } = {}) {
  let snapshotRef = reactExports.useRef();
  ...
  return reactExports.useSyncExternalStore(subscribe, get, server)
}
...
function persistentAtom(name, initial, opts = {}) {
...
const $shopifyCartId = persistentAtom(CART_ID_STORAGE_KEY, null, {
  encode: (value) => value ?? "",
  decode: (value) => value || null
});
const $shopifyCart = atom(null);
let hydrationPromise = null;
async function hydrateShopifyCart() {
  ...
  if (!hydrationPromise) {
    hydrationPromise = getCart(cartId).then((cart) => {
      if (!cart) {
        clearShopifyCart();
        return null;
      }
...
function syncShopifyCart(nextCart) {
...
const SUB_DISCOUNT = 0.9;
function calcLineUnitPrice(basePrice, quantity, attrs) {
...
function getLineStep(_attrs) {
  return 1;
}
function calcCartSubtotal(lines) {
...
function CartLines({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("space-y-5", !compact && "space-y-8"), children: lines.map((line) => {
    ...
    const packLabel = sizeAttr === "bundle" ? "Pack: Bundle (2 Bottles)" : "Pack: Full (1 Bottle)";
    const paymentLabel = purchaseAttr === "sub" ? "Plan: Subscribe & Save" : "Plan: One-time";
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          line.merchandise.product.featuredImage && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: cn(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: packLabel }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: paymentLabel }),
            line.merchandise.selectedOptions.filter((o) => o.value.trim().length > 0).map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between mt-3 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 border border-border rounded-md", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    "aria-label": "Decrease quantity",
                    disabled: isUpdating,
                    onClick: () => onQtyChange(line.id, Math.max(0, line.quantity - step)),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 text-center text-sm font-medium tabular-nums", children: isUpdating ? "…" : line.quantity }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    "aria-label": "Increase quantity",
                    disabled: isUpdating,
                    onClick: () => onQtyChange(line.id, line.quantity + step),
                    className: "px-2 py-1 text-muted-foreground hover:text-foreground transition disabled:opacity-40",
...
const CartDrawer = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open, onOpenChange: (v) => $cartOpen.set(v), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "right", className: "flex flex-col p-0 w-full sm:max-w-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { className: "px-6 py-5 border-b border-border shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetTitle, { className: "font-serif text-xl tracking-tight", children: [
      "Your Bag",
      !isEmpty && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-sm font-sans font-normal text-muted-foreground", children: [
        "(",
        cart.totalQuantity,
        " ",
    ...
    isEmpty ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center justify-center gap-4 px-6 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ShoppingBag,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-xl mb-1", children: "Your bag is empty" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Add something beautiful to get started." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
      ...
      (() => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-5 border-t border-border space-y-3 shrink-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "Shipping & taxes calculated at checkout" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: "/cart",
...
export { $cartOpen as $, CartDrawer as C, Description as D, Minus as M, Overlay as O, Plus as P, Root as R, Search as S, Title as T, User as U, ShoppingBag as a, CartLines as b, calcCartSubtotal as c, $shopifyCartId as d, $shopifyCart as e, Portal as f, Content as g, hydrateShopifyCart as h, Close as i, Trigger as j, useId as k, syncShopifyCart as s, useStore as u };
