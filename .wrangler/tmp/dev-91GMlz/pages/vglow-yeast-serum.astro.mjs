...
const vglowHero = "/_astro/vglow-hero.DCJkWEB7.png";

const vglowBottle = "/_astro/vglow-bottle-ingr.BOpmjqFP.png";

const vglowLaidOut = "/_astro/vglow-laid-out.CcWGH5t0.png";

const vglowUsage = "/_astro/vglow-usage.Bs7PCG30.png";

const vglowUsing = "/_astro/vglow-using.DNNuVIHA.png";

const vglowInfo = "/_astro/vglow-info.CzZQOBKX.png";

const yoniCareSpray = "/_astro/yoni-care-spray.DolpFAH4.png";
...
const VglowYeastSerum = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-ink-deep text-primary-foreground text-center text-[11px] tracking-[0.18em] uppercase py-2.5 px-4", children: "FDA-registered · Dermatologist-formulated · Free 3-day shipping in the USA" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "border-b border-border/60 bg-background/95 backdrop-blur sticky top-0 z-40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1320px] mx-auto px-4 sm:px-5 lg:px-10 h-16 lg:h-20 flex items-center justify-between gap-3 sm:gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-7 text-sm tracking-wide text-muted-foreground flex-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-foreground transition", children: "Feminine Care" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-foreground transition", children: "Skin Therapy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-foreground transition", children: "About" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1320px] mx-auto px-4 sm:px-5 lg:px-10 pt-6 text-[11px] tracking-[0.15em] uppercase text-muted-foreground overflow-x-auto scrollbar-hide whitespace-nowrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-foreground", children: "Feminine Care" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-2", children: "/" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-foreground", children: "BV · Yeast · Daily Freshness" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-2", children: "/" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Vglow Boric Acid Spray" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-[1320px] mx-auto px-4 sm:px-5 lg:px-10 py-6 lg:py-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7 flex flex-col-reverse md:flex-row md:items-start gap-3 md:gap-4 min-w-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 w-full min-w-0 bg-peach rounded-xl overflow-hidden aspect-[4/5]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute top-4 left-4 z-10 text-[10px] tracking-[0.25em] uppercase bg-background/95 backdrop-blur text-foreground px-3 py-1.5 rounded-full font-medium shadow-sm flex items-center gap-1.5", children: [
            ...
            " Dermatologist-formulated · FDA-registered"
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: PRODUCT_IMAGES[activeImage].src, alt: PRODUCT_IMAGES[activeImage].alt, className: "absolute inset-0 size-full object-cover", loading: "eager", decoding: "async" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] tracking-[0.22em] uppercase font-medium bg-foreground text-background px-2.5 py-1 rounded", children: "Women · Daily Use · Non-Toxic" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] tracking-[0.22em] uppercase text-muted-foreground mb-2", children: "Vglow · Feminine Wellness" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-serif text-[2.25rem] md:text-5xl leading-[1.02] mb-4 tracking-tight", children: "Boric Acid BV & Yeast Spray" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-muted-foreground mb-5 leading-relaxed", children: "A gentle, non-toxic spray that calms itch, neutralizes odor and restores healthy pH — without antibiotics, suppositories or another awkward doctor's visit." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mb-6", children: ["BV Relief", "Yeast Infection", "Odor", "Itch", "Recurring", "Daily Freshness"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] px-2.5 py-1 rounded-full bg-secondary text-foreground/80", children: t }, t)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0.5", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: cn("h-3.5 w-3.5", i < 4 ? "text-accent fill-accent" : "text-accent fill-accent/40") }, i)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#reviews", className: "text-sm underline underline-offset-4 text-muted-foreground hover:text-foreground", children: "Verified customer stories" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "·" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Spray, not suppository" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground", children: pack === "bundle" ? "2 × 4 fl oz · ~120-day supply" : "4 fl oz · 118 ml" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => isBundleAvailable && setPack("bundle"), disabled: !isBundleAvailable, className: cn("relative w-full px-4 pt-5 pb-3.5 rounded-md border-2 transition flex items-center justify-between gap-3 text-left", pack === "bundle" ? "border-foreground bg-secondary/40" : "border-accent/60 hover:border-foreground/70 bg-peach/30", !isBundleAvailable && "opacity-50 cursor-not-allowed"), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-2 left-4 text-[9px] tracking-[0.2em] uppercase font-medium bg-accent text-accent-foreground px-2 py-0.5 rounded-full shadow-sm", children: "Most Popular · Save 20%" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-ink-deep", children: "2-Bottle Bundle" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] tracking-widest uppercase text-muted-foreground mt-0.5", children: "Subscribe & save" })
                ] })
              ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "w-full h-12 mb-5 rounded-md border border-foreground/20 text-xs tracking-[0.12em] uppercase font-medium hover:bg-secondary/60 transition", children: "Buy Now — Discreet shipping in plain packaging" }),
        ...
        ].map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square w-14 sm:w-16 lg:w-20 flex items-center justify-center overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: b.src, alt: b.label, title: b.label, loading: "lazy", className: "w-full h-full object-contain opacity-80 hover:opacity-100 transition-opacity", style: { transform: `scale(${b.scale})` } }) }, b.label)) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionContent, { className: "text-[13px] text-muted-foreground leading-relaxed pb-5 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                "Boric Acidum 6X HPUS — Antifungal & pH support",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                "Chamomilla Recutita 8X HPUS — Anti-Inflammatory"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Glycerin, Azadirachta Indica (Neem) Extract, Peppermint Oil, Pongamia Glabra (Karanja) Oil, Acorus Calamus (Sweet Flag) Oil, Curcuma Longa (Turmeric) Extract, Xanthan Gum, Aqua." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-foreground/60", children: "For external use only. Do not use during pregnancy, breastfeeding, or on children under 12. Avoid use on open cuts or sores. Boric acid should never be ingested. Free of parabens, sulfates, dyes and synthetic fragrance." })
          ] })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-peach", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 py-10 lg:py-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-2", children: "Clinical literature · Boric acid for BV & vulvovaginal candidiasis" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-2xl md:text-3xl", children: "Quiet days. Fresh nights. You — uninterrupted." })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-center text-foreground/50 mt-8 tracking-wider", children: "Clinical figures referenced from Iavazzo et al., J Womens Health 2011 and supplemental BV co-therapy studies. Individual experience varies." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-5 lg:px-10 py-16 lg:py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-10 lg:mb-14", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm md:text-base text-ink-deep/70", children: "BV and yeast flare-ups rarely travel alone — odor, irritation and pH swings come with them. Add the Yoni-Care daily deodorizer and our Turmeric Soap to keep things calm, fresh and balanced between sprays." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-peach/40 ring-1 ring-border p-6 sm:p-10 lg:p-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr_auto_1fr] gap-6 lg:gap-4 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square w-full max-w-[200px] rounded-2xl bg-background ring-1 ring-border overflow-hidden flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: vglowHero, alt: "Vglow Boric Acid BV & Yeast Spray, 4 fl oz", className: "h-full w-full object-contain", loading: "lazy" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 text-xs tracking-[0.18em] uppercase text-accent", children: "This bottle" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 font-serif text-lg text-ink-deep", children: "Boric Acid BV & Yeast Spray" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-ink-deep/60", children: "4 fl oz · 118 ml" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-sm font-medium text-ink-deep", children: [
              "$",
              singlePrice.toFixed(2)
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square w-full max-w-[200px] rounded-2xl bg-background ring-1 ring-border overflow-hidden flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: yoniCareSpray, alt: "Yoni-Care Organic Life Herbal Feminine Care Spray, 4 fl oz", className: "h-full w-full object-contain", loading: "lazy" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 text-xs tracking-[0.18em] uppercase text-accent", children: "Add" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 font-serif text-lg text-ink-deep", children: "Yoni-Care Feminine Spray" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-ink-deep/60", children: "Anti-itch · Deodorizer · All natural" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-sm font-medium text-ink-deep", children: [
              "$",
              yoniCarePrice.toFixed(2)
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center text-3xl font-serif text-ink-deep/40", children: "+" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square w-full max-w-[200px] rounded-2xl bg-background ring-1 ring-border overflow-hidden flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: turmericSoap, alt: "Celsius Herbs Turmeric Soap bar for sensitive skin", className: "h-full w-full object-contain", loading: "lazy" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 text-xs tracking-[0.18em] uppercase text-accent", children: "Add" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 font-serif text-lg text-ink-deep", children: "Turmeric Soap" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-ink-deep/60", children: "Daily cleanse · Brightens · Calms" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-sm font-medium text-ink-deep", children: [
              "$",
              turmericSoapPrice.toFixed(2)
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 pt-8 border-t border-border/70 flex flex-col md:flex-row items-center justify-between gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center md:justify-start gap-3 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-serif text-3xl text-ink-deep", children: [
                "$",
                crossSellPrice.toFixed(2)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-base text-muted-foreground line-through", children: [
                "$",
                crossSellOriginal.toFixed(2)
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-medium text-accent bg-accent/10 px-2 py-1 rounded-full", children: [
                "Save $",
                crossSellSavings.toFixed(2)
              ] })
            ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 py-16 lg:py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10 lg:mb-14 max-w-2xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.25em] uppercase text-accent mb-3", children: "You're not alone in this" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-[15px] leading-relaxed", children: "Recurring BV and yeast infections affect more than 1 in 3 women — yet almost no one talks about them. Here's what most women tell us they're feeling before they switch to Vglow." })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-2xl md:text-3xl text-ink-deep max-w-2xl mx-auto leading-snug", children: '"After 3 days, the itch was gone. By the end of the week, so was the smell. I cried in the bathroom — happy tears, finally."' }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] tracking-[0.22em] uppercase text-muted-foreground mt-4", children: "— the most common message we receive from new Vglow customers" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 pb-16 lg:pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-7 order-2 lg:order-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl overflow-hidden bg-secondary/40 aspect-[4/5] sm:aspect-[5/4] lg:aspect-[4/5]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: vglowLaidOut, alt: "Vglow spray held in hand — natural relief, everyday confidence", className: "absolute inset-0 w-full h-full object-cover", loading: "lazy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 bg-gradient-to-t from-ink-deep/85 via-ink-deep/45 to-transparent pt-12 sm:pt-16 px-5 pb-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-background leading-snug max-w-[26ch] sm:max-w-md", style: { fontSize: "clamp(1rem, 3.6vw, 1.875rem)" }, children: '"Restore the pH. Calm the irritation. Break the recurrence cycle."' })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5 order-1 lg:order-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-6", children: "Boric acid restores the acidic pH (3.8–4.5) that keeps Gardnerella and Candida from regrowing. Chamomile and aloe calm the burning, redness and tenderness within minutes. Tea tree and karanja support the lactobacillus balance — so the infection doesn't bounce back next month." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { dangerouslySetInnerHTML: { __html: t } })
        ] }, t)) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 pb-16 lg:pb-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10 lg:mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.25em] uppercase text-accent mb-3", children: "Know your symptoms" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif text-3xl md:text-5xl leading-[1.05] mb-4", children: [
          "Two infections.",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", { className: "sm:hidden" }),
          " One gentle bottle."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-2xl mx-auto text-[15px] leading-relaxed", children: "Bacterial vaginosis and yeast (candida) feel similar — itch, odor, discharge — but the root cause is opposite. BV is a bacterial imbalance; yeast is a fungal overgrowth. Here's what each looks like, and what Vglow is formulated to do about it." })
      ] }),
      (() => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-5", children: conditions.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: cn("rounded-2xl border p-6 lg:p-7 flex flex-col h-full transition", c.accent ? "bg-foreground text-background border-foreground shadow-sm" : "bg-background border-border hover:shadow-sm"), children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("text-[10px] tracking-[0.2em] uppercase mb-3", c.accent ? "text-background/60" : "text-muted-foreground"), children: "What Vglow targets" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2 mt-auto", children: c.symptoms.map((s) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2.5 text-sm", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("leading-snug", c.accent ? "text-background/90" : "text-foreground/85", s.level === "none" && (c.accent ? "text-background/40 line-through" : "text-muted-foreground line-through")), dangerouslySetInnerHTML: { __html: s.label } })
              ] }, s.label);
            }) })
          ] }, c.name)) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-center text-foreground/50 mt-5 tracking-wider max-w-2xl mx-auto", children: "Educational information only. Severe pelvic pain, fever, pregnancy, or symptoms persisting past 14 days warrant evaluation by a licensed healthcare provider." })
        ] });
      })()
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-secondary/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 py-16 lg:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-7 order-2 lg:order-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("figure", { className: "relative aspect-[4/5] sm:aspect-[5/4] rounded-2xl overflow-hidden bg-background ring-1 ring-border/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: vglowInfo,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5 order-1 lg:order-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.25em] uppercase text-accent mb-3", children: "A daily ritual, not a rescue" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl md:text-4xl lg:text-5xl leading-tight mb-5", children: "Care that understands you." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "border-l-2 border-accent pl-4 mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/80 text-[15px] leading-relaxed italic", children: '"I bought it expecting another product to add to the failed pile. Within three days, the smell was gone. Within a week, I felt like myself for the first time in months."' }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "text-[11px] tracking-[0.18em] uppercase text-foreground/60 mt-3", children: "— Verified buyer, repeat customer" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 text-base leading-relaxed mb-5", children: "Vglow was built for the woman who is tired of cycling between antibiotics, suppositories and embarrassed Google searches. A few seconds, twice a day, and your body remembers what balance feels like." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2.5 text-sm text-foreground/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2.5", children: [
            ...
            " Less itch within 24–48 hours"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-accent shrink-0 mt-0.5" }),
            " Odor neutralized within 3–5 days"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-accent shrink-0 mt-0.5" }),
            " Discharge normalizes by day 7"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-accent shrink-0 mt-0.5" }),
            " Confidence — quietly, on your terms"
          ] })
        ] })
      ] })
    ] }) }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10 mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif text-3xl md:text-5xl leading-[1.05] mb-5", children: [
            "Four botanicals.",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Dermatologist-formulated for women."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Every active was chosen for two reasons: clinically supported antifungal and pH-restoring action, and a non-stinging, non-toxic profile gentle enough for daily intimate use." })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-secondary/40 py-12 lg:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-5 lg:px-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-center text-foreground/50 mt-10 tracking-wider max-w-2xl mx-auto", children: "For external use only. Avoid use during pregnancy or on broken skin. Discontinue if irritation worsens and consult your provider." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-ink-deep text-primary-foreground py-16 lg:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1100px] mx-auto px-5 lg:px-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.25em] uppercase text-accent mb-3", children: "Why women switch" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl md:text-5xl mb-3", children: "Vglow vs. antibiotics & suppositories" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/60 max-w-lg mx-auto text-sm", children: "The same active power gynecologists trust — without the antibiotic resistance, the suppository leakage, the gut-microbiome disruption, or the awkwardness of another doctor's visit." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl overflow-hidden border border-primary-foreground/15 bg-primary-foreground/[0.02]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 bg-primary-foreground/[0.06] text-[10px] tracking-[0.2em] uppercase", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 lg:p-5 text-accent border-l border-primary-foreground/15 font-medium", children: "Vglow Spray" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 lg:p-5 text-primary-foreground/50 border-l border-primary-foreground/15", children: "Conventional Treatment" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-peach", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1200px] mx-auto px-5 lg:px-10 py-16 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("figcaption", { className: "mt-5 flex flex-col items-center gap-1.5 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-lg text-ink-deep", children: "Dr. Alpana Mohta" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] tracking-[0.25em] uppercase text-accent", children: "Dual board-certified Dermatologist · FEADV" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7 text-center lg:text-left", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("blockquote", { className: "font-serif text-xl md:text-2xl leading-snug text-ink-deep", children: `"Boric acid has clinical cure rates approaching 100% in vulvovaginal candidiasis, and adding it to standard BV protocols raises success rates from 70–80% up to 92% — by removing the bacterial biofilms antibiotics miss. For recurrent cases, it's the missing link."` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] tracking-[0.2em] uppercase text-foreground/55 mt-5", children: "100+ peer-reviewed publications · British Association of Dermatologists travel grant · Imrich Sarkany Memorial Scholarship" })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-peach/40 py-20 lg:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1320px] mx-auto px-5 lg:px-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/5] rounded-2xl overflow-hidden", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: vglowUsage, alt: "Boric acid, aloe vera, tea tree and calendula — Vglow's botanical actives", loading: "lazy", decoding: "async", className: "absolute inset-0 w-full h-full object-cover" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-5 left-5 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-background/90 backdrop-blur text-[10px] tracking-[0.22em] uppercase text-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Droplet, { className: "w-3 h-3 text-accent", strokeWidth: 2 }),
            "Homeopathic 6X HPUS"
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/75 leading-relaxed mb-5 max-w-xl", children: "Boric acid has been used in feminine care since the 1860s — and modern dermatology research keeps confirming what generations of women already knew. Vglow combines that lineage with FDA-registered homeopathic standards (6X HPUS), so each active reaches the irritated tissue at a clinically meaningful dose, without the resistance and recurrence problems of antibiotics." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/75 leading-relaxed max-w-xl", children: "The result is an alcohol-free, paraben-free, non-stinging spray gentle enough for daily wellness use — yet decisive enough to break the chronic recurrence cycle within days." })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-3xl mx-auto px-5 lg:px-10 py-16 lg:py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.25em] uppercase text-accent mb-3", children: "Your questions, answered" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl md:text-5xl", children: "Reviewed by Dr. Alpana Mohta" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-3 max-w-md mx-auto", children: "Dual board-certified dermatologist, Fellow of the European Academy of Dermatology and Venereology." })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "reviews", className: "max-w-[1320px] mx-auto px-5 lg:px-10 py-16 lg:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.25em] uppercase text-accent mb-3", children: "Real women · Real results" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl md:text-5xl mb-5", children: "She felt like herself again — quietly." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-5xl text-ink-deep", children: "4.8" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5 mb-1", children: [...Array(5)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: cn("h-4 w-4", i < 4 ? "fill-accent text-accent" : "fill-accent/40 text-accent") }, i)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Verified buyers · Walmart & direct" })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-8 space-y-3", children: REVIEW_STRUCTURE.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary/30 rounded-xl p-6 lg:p-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-[15px] text-foreground/85 leading-relaxed mb-3", children: r.body }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] tracking-[0.18em] uppercase text-muted-foreground", children: [
          "— ",
          r.name
        ] })
      ] }, i)) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-ink-deep text-primary-foreground py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 grid grid-cols-2 md:grid-cols-4 gap-8 mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 md:col-span-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-primary-foreground/60 leading-relaxed max-w-xs", children: "Plant-powered, dermatologist-formulated feminine, skin and pet care. Made in the USA." })
        ] }),
        [
          { h: "Shop", l: ["Feminine Care", "Skin Therapy", "Pet Care", "Best Sellers"] },
          { h: "Help", l: ["Contact", "Discreet Shipping", "Returns", "FAQ"] },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("lg:hidden fixed bottom-0 inset-x-0 z-50 bg-background/95 backdrop-blur border-t border-border", "px-4 py-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))]", "transition-transform duration-300 ease-out shadow-[0_-8px_24px_-12px_hsl(var(--ink-deep)/0.18)]", showStickyBar ? "translate-y-0" : "translate-y-full"), role: "region", "aria-label": "Purchase bar", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: vglowHero, alt: "", className: "w-10 h-10 rounded-md object-cover bg-peach ring-2 ring-background shrink-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-ink-deep/70 tracking-wide truncate", children: "Vglow Boric Acid Spray · 4 fl oz" }),
...
function VglowYeastSerumIsland() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageRoot, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(VglowYeastSerum, {}) });
}

const $$VglowYeastSerum = createComponent(async ($$result, $$props, $$slots) => {
  const staticMeta = {
    title: "Vglow Yeast Serum | Celsius Herbs",
    description: "Targeted serum support \u2014 Celsius Herbs.",
    canonical: "https://celsiusherbs.com/vglow-yeast-serum"
  };
  const merged = await mergeShopifyProductSeo(SHOPIFY_PRODUCT_HANDLES.vglowYeastSerum, staticMeta);
  const { jsonLd, ...layoutProps } = merged;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { ...layoutProps, "jsonLd": jsonLd }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "VglowYeastSerumIsland", VglowYeastSerumIsland, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/bruno/Downloads/Projeto/celsius-astrolovable/src/islands/pdp/VglowYeastSerum", "client:component-export": "default" })} ` })}`;
}, "C:/Users/bruno/Downloads/Projeto/celsius-astrolovable/src/pages/vglow-yeast-serum.astro", void 0);

const $$file = "C:/Users/bruno/Downloads/Projeto/celsius-astrolovable/src/pages/vglow-yeast-serum.astro";
const $$url = "/vglow-yeast-serum";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$VglowYeastSerum,
  file: $$file,
  url: $$url
