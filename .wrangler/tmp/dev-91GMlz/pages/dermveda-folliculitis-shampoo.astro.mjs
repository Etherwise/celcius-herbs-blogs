    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: "rounded-full px-4 h-10 text-[11px] tracking-[0.16em] uppercase bg-ink-deep text-primary-foreground hover:bg-ink-deep/90 shrink-0", children: "Shop set" })
        ] })
      }
    )
  ] });
...
function DermvedaFolliculitisShampooIsland() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageRoot, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DermvedaFolliculitisShampoo, {}) });
}

const $$DermvedaFolliculitisShampoo = createComponent(async ($$result, $$props, $$slots) => {
  const staticMeta = {
    title: "Dermveda Folliculitis Shampoo | Celsius Herbs",
    description: "Dermveda therapeutic shampoo for folliculitis \u2014 Celsius Herbs.",
    canonical: "https://celsiusherbs.com/dermveda-folliculitis-shampoo"
  };
  const merged = await mergeShopifyProductSeo(
    SHOPIFY_PRODUCT_HANDLES.dermvedaFolliculitisShampoo,
    staticMeta
  );
  const { jsonLd, ...layoutProps } = merged;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { ...layoutProps, "jsonLd": jsonLd }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "DermvedaFolliculitisShampooIsland", DermvedaFolliculitisShampooIsland, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/bruno/Downloads/Projeto/celsius-astrolovable/src/islands/pdp/DermvedaFolliculitisShampoo", "client:component-export": "default" })} ` })}`;
}, "C:/Users/bruno/Downloads/Projeto/celsius-astrolovable/src/pages/dermveda-folliculitis-shampoo.astro", void 0);

const $$file = "C:/Users/bruno/Downloads/Projeto/celsius-astrolovable/src/pages/dermveda-folliculitis-shampoo.astro";
const $$url = "/dermveda-folliculitis-shampoo";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$DermvedaFolliculitisShampoo,
  file: $$file,
  url: $$url
