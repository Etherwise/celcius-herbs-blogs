...
const catHero = "/_astro/cat-pdp-hero.Br5900W2.jpg";

const catApplicationVideo = "/_astro/cat-application-video.CHvx-Kn4.mp4";

const catApplication = "/_astro/cat-pdp-application.CUWm8Gx7.jpg";

const catLifestyle1 = "/_astro/cat-pdp-lifestyle-1.Df7hC6N3.jpg";

const catLifestyle2 = "/_astro/cat-pdp-lifestyle-2.ByUYacQR.jpg";

const catFlatlay = "/_astro/cat-pdp-flatlay.COdh8V9Y.jpg";

const catVetPortrait = "/_astro/cat-vet-portrait.DPL_SlSR.png";

const ingMoringa = "/_astro/cat-ing-moringa.CSRMPZhs.jpg";

const ingTurmeric = "/_astro/cat-ing-turmeric.W4K0zxX8.jpg";

const ingAloe = "/_astro/cat-ing-aloe.Dk_uzHbJ.jpg";

const ingGlycerin = "/_astro/cat-ing-glycerin.DiJJC_VC.jpg";

const spotlightCatItch = "/_astro/spotlight_7_cat_itch_v2.CI4wJJS_.png";

const spotlightAntiItch = "/_astro/spotlight_8_anti_itch_v2.C4564MZ2.png";

const catFleaTickDrops = "/_astro/cat-flea-tick-drops-scene.C-wH1h-L.jpg";

const catFleaTickShampoo = "/_astro/cat-flea-tick-shampoo-scene.QikWjoeD.jpg";

const catBeforeAfter = "/_astro/cat-before-after-skin.DvxBCgVv.jpg";

const catBeforeMild = "/_astro/cat-before-mild-inflammation.DLHSC8yd.jpg";

const catAfterHealed = "/_astro/cat-after-healed-skin.BytWbts2.jpg";

const catStep1 = "/_astro/cat-step-1-part.k313DFmD.jpg";

const catStep2 = "/_astro/cat-step-2-apply.CkR7Wckg.jpg";

const catStep3 = "/_astro/cat-step-3-massage.Dv9s0slM.jpg";

const catStep4 = "/_astro/cat-step-4-repeat.Dwoa7tB4.jpg";
...
const IngredientSlider = () => {
  ...
  [useStore($cartOpen), (v) => $cartOpen.set(v)];
  useStore($shopifyCart);
...
const CatDandruffLotion = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-ink-deep text-primary-foreground text-center text-[11px] tracking-[0.18em] uppercase py-2.5 px-4", children: "Vet-formulated · Lick-safe · Free 3-day shipping in the USA" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1320px] mx-auto px-4 sm:px-5 lg:px-10 pt-6 text-[11px] tracking-[0.15em] uppercase text-muted-foreground overflow-x-auto scrollbar-hide whitespace-nowrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-foreground", children: "Cat Skin Care" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-2", children: "/" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-foreground", children: "Dandruff & Dermatitis" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-2", children: "/" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Kitty Skin Lotion" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-[1320px] mx-auto px-4 sm:px-5 lg:px-10 py-6 lg:py-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7 flex flex-col-reverse md:flex-row gap-3 md:gap-4 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex md:flex-col gap-2.5 md:w-[88px] shrink-0 overflow-x-auto md:overflow-visible scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0", children: PRODUCT_IMAGES.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            "aria-label": img.alt,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: img.poster ?? img.src, alt: img.alt, className: "w-full h-full object-cover", loading: "lazy" }),
              img.video && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 flex items-center justify-center bg-foreground/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-7 w-7 rounded-full bg-background/95 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-0 h-0 border-y-[5px] border-y-transparent border-l-[7px] border-l-foreground ml-0.5" }) }) })
            ]
          },
          i
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 bg-peach rounded-xl overflow-hidden aspect-[4/5] min-w-0", children: [
          ...
          PRODUCT_IMAGES[activeImage].video ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "video",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] tracking-[0.22em] uppercase font-medium bg-foreground text-background px-2.5 py-1 rounded", children: "Lick-Safe · Topical" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] tracking-[0.22em] uppercase text-muted-foreground mb-2", children: "PetGlow · Feline Skin Therapy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-serif text-[2.25rem] md:text-5xl leading-[1.02] mb-4 tracking-tight", children: "Kitty Skin Relief Lotion" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[15px] text-muted-foreground mb-5 leading-relaxed", children: "Rapid relief for itchy, flaky, dandruff-prone and miliary-dermatitis skin. Plant-based, lick-safe and vet-formulated to calm the scratching cycle in days — not weeks." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mb-6", children: ["Cat Dandruff", "Miliary Dermatitis", "Dry Flaking", "Allergy Itch", "Senior Cats"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] px-2.5 py-1 rounded-full bg-secondary text-foreground/80", children: t }, t)) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground", children: pack === "bundle" ? "2 × 4 fl oz · 60-day supply" : "4 fl oz · 118ml" })
          ] }),
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] tracking-widest uppercase text-accent mt-0.5", children: "Best value" })
                    ] })
                  ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { type: "single", collapsible: true, className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionItem, { value: "ingredients", className: "border-b-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AccordionContent, { className: "text-[13px] text-muted-foreground leading-relaxed pb-5 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.22em] uppercase text-foreground/70 mb-1.5", children: "Active botanicals" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Organic Moringa Oleifera Leaf Extract, Organic Aloe Barbadensis Leaf Extract, Organic Curcuma Longa (Turmeric) Root Extract." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.22em] uppercase text-foreground/70 mb-1.5", children: "Base" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Vegetable Glycerin, Xanthan Gum, Aqua (Purified Water)." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-foreground/60", children: "Free of parabens, sulfates, alcohol, steroids, fragrance, and artificial dyes. Lick-safe at the nano-particle level." })
          ] })
        ] }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-peach", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 py-10 lg:py-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.25em] uppercase text-foreground/60 mb-2", children: "Pet Parent Survey · 2 Weeks · n=128 cats" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-2xl md:text-3xl", children: "A calmer cat. A quieter night." })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-center text-foreground/50 mt-8 tracking-wider", children: "Self-reported pet-parent observation study, n=128 cats with mild–moderate dandruff or miliary dermatitis, 1–2 daily applications over 14 days." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 py-16 lg:py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10 lg:mb-14 max-w-2xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif text-3xl md:text-5xl leading-[1.05] mb-4", children: [
          "The scratching isn't your fault.",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "Your cat just needs the right relief."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-[15px] leading-relaxed", children: "Cat skin issues are heartbreaking — and exhausting. Here's what most pet parents tell us they're feeling before they find PetGlow." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5", children: CAT_PAIN_POINTS.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary/40 rounded-2xl p-6 lg:p-7 hover:bg-secondary transition flex flex-col", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-2xl md:text-3xl text-ink-deep max-w-2xl mx-auto leading-snug", children: '"Within two days the scratching stopped. By day five, the flakes were gone. I cried."' }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 pb-16 lg:pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-7 order-2 lg:order-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl overflow-hidden bg-secondary/40 aspect-[4/5] sm:aspect-[5/4] lg:aspect-[4/5]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "video",
          {
            ...
            playsInline: true,
            onEnded: (e) => {
              const overlay = e.currentTarget.parentElement?.querySelector("[data-end-cta]");
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 bg-gradient-to-t from-ink-deep/85 via-ink-deep/45 to-transparent pt-12 sm:pt-16 px-5 pb-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-background leading-snug max-w-[26ch] sm:max-w-md", style: { fontSize: "clamp(1rem, 3.6vw, 1.875rem)" }, children: '"Calm the itch. Heal the skin. Break the scratch cycle."' })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-accent text-accent-foreground text-[9px] tracking-[0.22em] uppercase mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-3 h-3", strokeWidth: 2 }),
                " Ready to try it?"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-background text-2xl md:text-3xl leading-snug max-w-sm mb-5", children: "Give your cat the relief they've been waiting for." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-2.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    children: "Shop the Bundle · Save 20%"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    onClick: () => {
                      const v = window.__catMechVideoEl;
                      if (v) {
                        v.currentTime = 0;
                        v.play();
                      }
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { className: "w-4 h-4", strokeWidth: 2 }),
                      " Replay"
                    ]
                  }
                )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5 order-1 lg:order-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-6", children: "Turmeric's curcumin shuts down the inflammatory cascade behind the itch. Aloe and moringa cool and rebuild the skin barrier. Glycerin draws moisture back into dry, indoor-dry feline skin so flakes stop returning." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 pb-16 lg:pb-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10 lg:mb-14", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] tracking-[0.25em] uppercase text-accent mb-3", children: "Know your cat's skin" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif text-3xl md:text-5xl leading-[1.05] mb-4", children: [
          "Three conditions.",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", { className: "sm:hidden" }),
          " One gentle lotion."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-2xl mx-auto text-[15px] leading-relaxed", children: "Cat dandruff, miliary dermatitis and dry flaky skin look similar — but each has a different root cause. Here's what each looks like, and what PetGlow is formulated to address." })
      ] }),
      (() => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-center text-foreground/50 mt-5 tracking-wider max-w-2xl mx-auto", children: "Symptom mapping is for educational purposes only. Persistent, worsening or open-wound conditions should be evaluated by a licensed veterinarian." })
        ] });
      })()
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-secondary/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 py-16 lg:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5 order-1 lg:order-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl md:text-4xl lg:text-5xl leading-tight mb-5", children: "Less itching. Softer coat. A happier cat." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 text-base leading-relaxed mb-5", children: "After 7 days of daily application, persistent flakes and miliary bumps visibly clear, the coat regains its softness, and the scratching that kept you both up at night finally quiets." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2.5 text-sm text-foreground/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2.5", children: [
            ...
            " Visible flake reduction in 2–4 days"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-accent shrink-0 mt-0.5" }),
            " Calmer skin — no redness, no scabbing"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-accent shrink-0 mt-0.5" }),
            " Coat softer to the touch within a week"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 text-accent shrink-0 mt-0.5" }),
            " Your cat purrs in your lap again"
          ] })
        ] })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "bundle", className: "max-w-[1320px] mx-auto px-5 lg:px-10 py-16 lg:py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl mx-auto mb-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl md:text-5xl leading-tight mb-5", children: "The Full Cat Skin & Coat Ritual" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 text-base leading-relaxed", children: "Skin flares rarely come alone. Pair the lotion with our flea & tick defense spray and plant-based shampoo to address the three most common triggers behind chronic feline scratching — all in one vet-formulated, lick-safe routine." })
      ] }),
      (() => {
        const items = [
        ...
        const bundlePrice2 = +(total * 0.8).toFixed(2);
        const savings = +(total - bundlePrice2).toFixed(2);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 py-16 lg:py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10 mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Every ingredient was chosen for two reasons: clinically supported skin-calming action, and safety if your cat licks the area afterward. Nano-particle absorption means zero residue." })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-secondary/40 py-12 lg:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1200px] mx-auto px-5 lg:px-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-8 lg:gap-x-8", children: ROUTINE.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex flex-col items-center text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full aspect-square rounded-full overflow-hidden bg-background shadow-[0_10px_30px_-12px_hsl(var(--foreground)/0.25)] ring-1 ring-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: r.image,
            alt: r.title,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-center text-foreground/50 mt-10 tracking-wider max-w-2xl mx-auto", children: "For external use on cats only. Avoid contact with eyes. Discontinue if irritation worsens." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-ink-deep text-primary-foreground py-16 lg:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1100px] mx-auto px-5 lg:px-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl md:text-5xl mb-3", children: "PetGlow vs. conventional cat skin treatments" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/60 max-w-lg mx-auto text-sm", children: "The same relief — without the steroids, the staining, the vet bills, or the guilt of your cat licking something they shouldn't." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl overflow-hidden border border-primary-foreground/15 bg-primary-foreground/[0.02]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 bg-primary-foreground/[0.06] text-[10px] tracking-[0.2em] uppercase", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 lg:p-5 text-primary-foreground/50 border-l border-primary-foreground/15", children: "Vet Steroid Cream" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-peach", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1200px] mx-auto px-5 lg:px-10 py-16 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-5 flex justify-center lg:justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-[260px] h-[260px] md:w-[340px] md:h-[340px] lg:w-[400px] lg:h-[400px]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-3 left-1/2 -translate-x-1/2 bg-background/95 backdrop-blur-sm px-5 py-2.5 rounded-full shadow-md text-center whitespace-nowrap border border-foreground/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-sm md:text-base text-ink-deep leading-tight", children: "Dr. Alex C" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] md:text-[10px] tracking-[0.2em] uppercase text-accent mt-0.5", children: "Vet · DVM" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7 text-center lg:text-left", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("blockquote", { className: "font-serif text-xl md:text-2xl leading-snug text-ink-deep", children: '"For mild to moderate feline dandruff and miliary dermatitis, a well-formulated turmeric and moringa lotion can be a meaningful first-line option — without the side-effects of long-term steroid use."' })
      ] })
    ] }) }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif text-3xl md:text-5xl lg:text-[3.25rem] leading-[1.05] mb-6 text-ink-deep", children: [
            "Where modern feline care",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "meets the herbal apothecary."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/75 leading-relaxed mb-5 max-w-xl", children: "Turmeric, moringa and aloe have been used in traditional veterinary practice for centuries — long before the prescription pad. PetGlow combines those roots with cold-process nano-emulsification, so each active reaches your cat's skin at a clinically meaningful dose, while remaining 100% safe if licked." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/75 leading-relaxed max-w-xl", children: "The result is an unscented, dye-free, steroid-free lotion gentle enough for kittens and seniors — yet decisive enough to break the scratching cycle within days." })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "reviews", className: "max-w-[1320px] mx-auto px-5 lg:px-10 py-16 lg:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10 mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl md:text-5xl mb-5", children: "Be the first to share your cat's story." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-ink-deep text-primary-foreground py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1320px] mx-auto px-5 lg:px-10 grid grid-cols-2 md:grid-cols-4 gap-8 mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 md:col-span-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-primary-foreground/60 leading-relaxed max-w-xs", children: "Plant-powered, vet-formulated skin & coat care for the cats and dogs you love. Made in the USA." })
        ] }),
        [
          { h: "Shop", l: ["Cat Skin Care", "Dog Skin Care", "Itch Relief", "Best Sellers"] },
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex -space-x-2 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: catHero, alt: "", className: "w-10 h-10 rounded-md object-cover bg-peach ring-2 ring-background" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: spotlightAntiItch, alt: "", className: "w-10 h-10 rounded-md object-cover bg-peach ring-2 ring-background" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: catFleaTickShampoo, alt: "", className: "w-10 h-10 rounded-md object-cover bg-peach ring-2 ring-background" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-ink-deep/70 tracking-wide truncate", children: "Lotion + Spray + Turmeric Soap" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-1.5 mt-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-[16px] leading-none text-ink-deep", children: "$37" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground line-through leading-none", children: "$46.97" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-medium tracking-[0.14em] uppercase text-accent leading-none", children: "Save $10" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
...
function CatDandruffLotionIsland() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageRoot, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CatDandruffLotion, {}) });
}

const $$CatDandruffLotion = createComponent(async ($$result, $$props, $$slots) => {
  const staticMeta = {
    title: "Cat Dandruff Lotion | Celsius Herbs",
    description: "Gentle dandruff care for cats \u2014 plant-based relief from Celsius Herbs.",
    canonical: "https://celsiusherbs.com/cat-dandruff-lotion"
  };
  const merged = await mergeShopifyProductSeo(SHOPIFY_PRODUCT_HANDLES.catDandruffLotion, staticMeta);
  const { jsonLd, ...layoutProps } = merged;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { ...layoutProps, "jsonLd": jsonLd }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "CatDandruffLotionIsland", CatDandruffLotionIsland, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/bruno/Downloads/Projeto/celsius-astrolovable/src/islands/pdp/CatDandruffLotion", "client:component-export": "default" })} ` })}`;
}, "C:/Users/bruno/Downloads/Projeto/celsius-astrolovable/src/pages/cat-dandruff-lotion.astro", void 0);

const $$file = "C:/Users/bruno/Downloads/Projeto/celsius-astrolovable/src/pages/cat-dandruff-lotion.astro";
const $$url = "/cat-dandruff-lotion";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$CatDandruffLotion,
  file: $$file,
  url: $$url
